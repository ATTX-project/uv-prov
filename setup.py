...
setup(
    ...
    name='ATTXuvproAPI',
    version='0.1',
    description='ATTX UVProvenance API',
    entry_points='''
        [console_scripts]
        uvprov=uvprov_api.uvprovapi:main
    ''',
    author_email='stefan.negru@helsinki.fi',
    url='https://www.helsinki.fi/en/projects/attx-2016',
    long_description="ATTX UVProvenance API for retrieving information form the ETL/Workflow tool necessary to construct provenance in the provenance service.",
